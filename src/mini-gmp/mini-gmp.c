...
#if _MSC_VER
// NOTE: These have been added to avoid compiler errors with
// the -WX option. Maybe it would be interesting to clean up
// all the errors instead.
#pragma warning(disable:4146) // unary minus operator applied to unsigned type, result still unsigned
#pragma warning(disable:4244) // conversion from 'mp_limb_t' to 'unsigned char', possible loss of data
#pragma warning(disable:4267) // conversion from 'size_t' to 'mp_bitcnt_t', possible loss of data
#endif
